...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8080';
    'jhipster.clientApp.name' = 'hackatonapp';
    ...
    'jhipster.mail.from' = 'hackatonapp@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'hackatonapp API';
    'jhipster.swagger.description' = 'hackatonapp API documentation';
    ...
    'eureka.instance.appname' = 'hackatonapp';
    'eureka.instance.instanceId' = 'hackatonapp:${random.value}';
