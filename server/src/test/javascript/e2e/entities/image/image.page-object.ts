...
export default class ImageComponentsPage extends AlertPage {
...
export class ImageDeleteDialog {
  ...
  title: ElementFinder = element(by.id('hackatonappApp.image.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-image'));
}
