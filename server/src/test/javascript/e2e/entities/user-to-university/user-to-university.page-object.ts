...
export default class UserToUniversityComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('user-to-university-heading'));
...
export class UserToUniversityDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('hackatonappApp.userToUniversity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-userToUniversity'));
}
