...
export default class DirectionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('direction-heading'));
...
export class DirectionDeleteDialog {
  ...
  title: ElementFinder = element(by.id('hackatonappApp.direction.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-direction'));
}
