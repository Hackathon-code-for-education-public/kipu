...
describe('Product e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Product page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/hackatonappApp.product.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/hackatonappApp.product.delete.question/);
