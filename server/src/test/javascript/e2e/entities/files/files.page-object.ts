...
export default class FilesComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('files-heading'));
...
export class FilesDeleteDialog {
  ...
  title: ElementFinder = element(by.id('hackatonappApp.files.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-files'));
}
