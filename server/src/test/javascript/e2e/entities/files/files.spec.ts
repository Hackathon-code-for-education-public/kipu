...
import FilesComponentsPage, { FilesDeleteDialog } from './files.page-object';
import FilesUpdatePage from './files-update.page-object';
import FilesDetailsPage from './files-details.page-object';
...
describe('Files e2e test', () => {
  ...
  let updatePage: FilesUpdatePage;
  let detailsPage: FilesDetailsPage;
  let listPage: FilesComponentsPage;
  let deleteDialog: FilesDeleteDialog;
  ...
  it('should load Files', async () => {
    await navBarPage.getEntityPage('files');
    listPage = new FilesComponentsPage();
  ...
  describe('Create flow', () => {
    it('should load create Files page', async () => {
      ...
      updatePage = new FilesUpdatePage();

      await waitUntilAllDisplayed([updatePage.title, updatePage.footer, updatePage.saveButton]);

      expect(await updatePage.title.getAttribute('id')).to.match(/hackatonappApp.files.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        deleteDialog = new FilesDeleteDialog();
        await waitUntilDisplayed(deleteDialog.dialog);

        expect(await deleteDialog.title.getAttribute('id')).to.match(/hackatonappApp.files.delete.question/);
      ...
      it('should load details Files page and fetch data', async () => {
        const detailsButton = listPage.getDetailsButton(listPage.records.last());
        await click(detailsButton);

        detailsPage = new FilesDetailsPage();
      ...
      it('should load edit Files page, fetch data and update', async () => {
