...
export default class ProfileComponentsPage extends AlertPage {
...
export class ProfileDeleteDialog {
  ...
  title: ElementFinder = element(by.id('hackatonappApp.profile.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-profile'));
}
