...
describe('Service Tests', () => {
  describe('Profile Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Profile(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Profile', async () => {
      ...
      it('should not partial update a Profile', async () => {
      ...
      it('should not return a list of Profile', async () => {
        axiosStub.get.rejects(error);
